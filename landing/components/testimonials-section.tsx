...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Undefined AI transformed how I learn. My notes became interactive mind maps and quizzes. The process is seamless and incredibly efficient!",
      image:
    ...
    {
      quote:
        "Undefined AI has revolutionized how I absorb complex topics. The AI-generated interfaces save me hours every week and make learning stick.",
      image:
    ...
    {
      quote:
        "The AI-powered learning interface is a game-changer. What used to take me days to understand now becomes clear through interactive timelines and structured content.",
      image:
