        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <div className="w-full h-full relative">
            {Array.from({ length: 300 }).map((_, i) => (
              <div
                key={i}
                className="absolute h-4 w-full -rotate-45 origin-top-left border-[0.5px] border-[rgba(3,7,18,0.08)]"
                style={{
                  top: `${i * 16 - 120}px`,
                  left: "-100%",
                  width: "300%",
        ...
        <div className="w-full max-w-[586px] px-6 py-5 md:py-8 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-6 relative z-20">
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
            ...
            <div className="self-stretch text-center text-[#605A57] text-base leading-7 font-sans font-medium">
              Stop scrolling through static content. Start learning in real time.
              <br />
              Let AI generate the exact interface you need to understand any topic faster.
            </div>
          </div>
