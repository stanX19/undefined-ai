...
class Chatbot:
    ...
    async def ask(
        ...
        Args:
            ...
            chat_history: Optional message history for context.
        ...
        Returns:
            tuple[str, list[BaseMessage]]: A tuple containing the text response and 
                any new messages generated by the agent.
        """
        ...
        try:
            ...
            traceback.print_exc()
            return "Rate limit reached. Please retry in 5 minutes.", []
