...
export function loadDemoSurface(): void {
  ...
  store.updateComponents("demo", [
    ...
    { id: "header", component: "Text", text: "Welcome to undefined ai", variant: "h1" },
    {
      ...
      component: "Tabs",
      tabItems: [
        { title: { literalString: "New UI" }, child: "ui_demo_card" },
    ...
    { id: "ui_demo_card", component: "Card", child: "ui_demo_col", title: "Soft Tech Design System" },
    { id: "ui_demo_col", component: "Column", children: ["badge_row", "avatar_row", "prog_row", "btn_row", "skel_row"] },
    { id: "badge_row", component: "Row", children: ["b1", "b2", "b3", "b4", "b5"] },
    { id: "b1", component: "Badge", text: "Success", status: "success" },
    { id: "b2", component: "Badge", text: "Warning", status: "warning" },
    { id: "b3", component: "Badge", text: "Error", status: "error" },
    { id: "b4", component: "Badge", text: "In Progress", status: "in-progress" },
    { id: "b5", component: "Badge", text: "Primary", status: "primary" },
    { id: "avatar_row", component: "Row", children: ["a1", "a2"] },
    { id: "a1", component: "Avatar", title: "User", size: "md" },
    { id: "a2", component: "Avatar", title: "Agent", isAgent: true, size: "lg" },
    { id: "prog_row", component: "Row", children: ["p1", "p2"] },
    { id: "p1", component: "Progress", variant: "bar", value: 75, label: "Generating...", showValue: true },
    { id: "p2", component: "Progress", variant: "ring", value: 42, label: "Analyzing" },
    { id: "btn_row", component: "Row", children: ["btn1", "btn2", "btn3"] },
    { id: "btn1", component: "Button", text: "Primary", variant: "primary" },
    { id: "btn2", component: "Button", text: "Secondary", variant: "secondary" },
    { id: "btn3", component: "Button", text: "Ghost", variant: "ghost" },
    { id: "skel_row", component: "Row", children: ["s1", "s2"] },
    { id: "s1", component: "Skeleton", variant: "circular" },
    { id: "s2", component: "Skeleton", variant: "text", width: "150px" },
